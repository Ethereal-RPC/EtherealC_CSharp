...
namespace EtherealC.Request.WebSocket
{
    public abstract class WebSocketRequest:Abstract.Request
    {
        ...
        protected override object Invoke(MethodInfo targetMethod, object[] args)
        {
                ...
                else
                {
                    ...
                    try{
                        ...
                        if (result != null)
                        {
                            ...
                            {
                                if ((rpcAttribute.InvokeType & Attribute.RequestMethod.InvokeTypeFlags.Fail) != 0)
                                {
                            ...
                            || Types.TypesByName.TryGetValue(targetMethod.GetCustomAttribute<Core.Attribute.AbstractType>(true)?.AbstractName, out type))
                            {
                                ...
                                if ((rpcAttribute.InvokeType & Attribute.RequestMethod.InvokeTypeFlags.Success) != 0
                                    || (rpcAttribute.InvokeType & Attribute.RequestMethod.InvokeTypeFlags.All) != 0)
                                {
                                    localResult = targetMethod.Invoke(this, args);
                                }
                            }
                        ...
                        else if((rpcAttribute.InvokeType & Attribute.RequestMethod.InvokeTypeFlags.Timeout) != 0)
                        { 
                            localResult = targetMethod.Invoke(this, args);
                        }
                    }
            ...
            if ((rpcAttribute.InvokeType & Attribute.RequestMethod.InvokeTypeFlags.ReturnRemote) != 0)
            {
                return remoteResult;
            }   
            if((rpcAttribute.InvokeType & Attribute.RequestMethod.InvokeTypeFlags.ReturnLocal) != 0)
            {
                return localResult;
            }
            return remoteResult;
