...
namespace EtherealC.RPCRequest
{
    public class WebSocketRequest:Request
    {
        ...
        public static new Request Register<T>(string netName, string servicename, WebSocketRequestConfig config)
        {
            Request proxy = (Request)(Create<T, WebSocketRequest>() as object);
